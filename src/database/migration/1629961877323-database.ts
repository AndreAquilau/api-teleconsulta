...
export class database1629961877323 implements MigrationInterface {
    name = 'database1629961877323'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."enderecos" ("id" SERIAL NOT NULL, "cep" character varying(255), "rua" character varying(255), "numero" integer, "complemento" text, "bairro" character varying(255), "cidade" character varying(120), "estado" character varying(120), "created_At" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_At" TIMESTAMP NOT NULL DEFAULT 'now()', CONSTRAINT "PK_208b05002dcdf7bfbad378dcac1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "pkey_id_endereco" ON "public"."enderecos" ("id") `);
        await queryRunner.query(`CREATE TABLE "public"."usuarios" ("id" SERIAL NOT NULL, "nome_completo" character varying(255) NOT NULL, "senha_hash" text NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_At" TIMESTAMP NOT NULL DEFAULT 'now()', CONSTRAINT "PK_d7281c63c176e152e4c531594a8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "public"."profissionais" ("id" SERIAL NOT NULL, "nome_completo" character varying(255) NOT NULL, "cpf" character varying(20), "sobre" text, "numero_conselho" integer, "duracao_atendimento" TIME, "created_At" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_At" TIMESTAMP NOT NULL DEFAULT 'now()', "fk_id_endereco" integer, "fk_id_usuario" integer, "fk_id_horario_atendimento" integer, "fk_id_especialidade" integer, "fk_id_conselho_regional" integer, "fk_id_uf_conselho" integer, CONSTRAINT "REL_94698e62d46340c94d403be309" UNIQUE ("fk_id_endereco"), CONSTRAINT "REL_d78e9e4126b28e789dcca3a3ce" UNIQUE ("fk_id_usuario"), CONSTRAINT "REL_9bf9fb9ebcff9d5ac15ca5ec6a" UNIQUE ("fk_id_horario_atendimento"), CONSTRAINT "REL_92a41790219e7f2e56c42db512" UNIQUE ("fk_id_especialidade"), CONSTRAINT "REL_ed70642c57a2673459bb3194c0" UNIQUE ("fk_id_conselho_regional"), CONSTRAINT "REL_ace58e5782a2236064b0e74be3" UNIQUE ("fk_id_uf_conselho"), CONSTRAINT "PK_a6a3048111c78bd06ecd3b1360c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "pkey_id_profissional" ON "public"."profissionais" ("id") `);
        await queryRunner.query(`CREATE TABLE "public"."atendimentos" ("id" SERIAL NOT NULL, "link_atendimento" character varying(600), "datetime_ini" TIMESTAMP WITH TIME ZONE, "datetime_fim" TIMESTAMP WITH TIME ZONE, "atendimento_inicializado" boolean, "atendimento_cancelado" boolean, "atendimento_finalizado" boolean, "created_At" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_At" TIMESTAMP NOT NULL DEFAULT 'now()', "fk_id_atendimento_profissional" integer, "fk_id_profissional_cliente" integer, CONSTRAINT "PK_80a70d057e68924b970871d9089" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "pkey_id_atendimento" ON "public"."atendimentos" ("id") `);
        await queryRunner.query(`CREATE TABLE "public"."consultorios" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "cnpj" character varying(20), "cpf" character varying(20), "celular" character varying(20), "telefone" character varying(20), "created_At" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_At" TIMESTAMP NOT NULL DEFAULT 'now()', "fk_id_endereco" integer, CONSTRAINT "REL_212b90e7518ead8930df37584e" UNIQUE ("fk_id_endereco"), CONSTRAINT "PK_d49fa6e5198ea5baef006955a35" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."profissionais" ADD CONSTRAINT "FK_9bf9fb9ebcff9d5ac15ca5ec6a3" FOREIGN KEY ("fk_id_horario_atendimento") REFERENCES "public"."horarioAtendimentos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."atendimentos" ADD CONSTRAINT "FK_5dd01c21fc49a28b016e1e105bf" FOREIGN KEY ("fk_id_profissional_cliente") REFERENCES "public"."clientes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "public"."consultorios" ADD CONSTRAINT "FK_212b90e7518ead8930df37584e5" FOREIGN KEY ("fk_id_endereco") REFERENCES "public"."enderecos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "public"."consultorios" DROP CONSTRAINT "FK_212b90e7518ead8930df37584e5"`);
        await queryRunner.query(`ALTER TABLE "public"."atendimentos" DROP CONSTRAINT "FK_5dd01c21fc49a28b016e1e105bf"`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."profissionais" DROP CONSTRAINT "FK_9bf9fb9ebcff9d5ac15ca5ec6a3"`);
